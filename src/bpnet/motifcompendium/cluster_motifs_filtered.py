"""UNUSED / EXPLORATION ONLY.

This entropy-based motif filter turned out to kill too many real motifs.
cluster_motifs.py (no built-in filtering) is the pipeline in active use;
its output feeds src/bpnet/hitcall/. Kept here for reference only.
"""
