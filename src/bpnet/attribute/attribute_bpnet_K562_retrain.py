"""Compute DeepLIFT/SHAP attributions for retrained models..

Usage:
    python src/bpnet/attribute/attribute_bpnet_K562_retrain.py --peak ENCSR261KBX --track ENCSR220XSM -v
"""
...
def main():
    ...
    model_name = f"{args.track}tracks_{args.peak}peaks"
    ...
    if args.ohe:
        ohe_path = out_dir / f"{args.peak}_ohe.npz"
    ...
    out_path = out_dir / f"{model_name}_{args.peak}_{args.head}.npz"
    out_dir.mkdir(parents=True, exist_ok=True)
