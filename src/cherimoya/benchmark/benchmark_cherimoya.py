"""
Benchmark a trained Cherimoya model across all folds.
...
Usage:
    python src/cherimoya/benchmark/benchmark_cherimoya.py -e ENCSR261KBX
"""
...
def main():
    ...
    if args.save_output:
        output_dir = REPO_ROOT / "predictions" / "cherimoya"
